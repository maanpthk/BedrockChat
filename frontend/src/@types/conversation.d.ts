...
export type ImageGenerationRequestContent = {
...
export type ImageGenerationResponseContent = {
  contentType: 'image_generation_response';
  imageData: string;
  mediaType: string;
  prompt: string;
  seed?: number;
...
export type VideoGenerationRequestContent = {
...
export type VideoGenerationResponseContent = {
  contentType: 'video_generation_response';
  videoData: string;
  mediaType: string;
  prompt: string;
  durationSeconds: number;
