        ...
        <div className="ml-5 grow ">
          ...
          {chatContent?.role === 'assistant' && (
            <>
              ...
              {chatContent.content.some(
                (content) => content.contentType === 'image_generation_response'
              ) && (
                <div key="generated-images" className="mb-4">
                  {chatContent.content.map((content, idx) => {
                    if (content.contentType === 'image_generation_response') {
                      return (
              ...
              {chatContent.content.some(
                (content) => content.contentType === 'video_generation_response'
              ) && (
                <div key="generated-videos" className="mb-4">
                  {chatContent.content.map((content, idx) => {
                    if (content.contentType === 'video_generation_response') {
                      return (
