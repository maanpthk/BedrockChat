  ...
  translation: {
    ...
    model: {
      ...
      'amazon-nova-canvas': {
        ...
        description:
          'State-of-the-art image generation model that creates high-quality, realistic images from text prompts.',
      },
      'amazon-nova-reel': {
        label: 'Amazon Nova Reel',
        description:
          'Advanced video generation model that creates short, high-quality videos from text descriptions.',
      },
    },
    agent: {
      label: 'Agent',
      ...
      tools: {
        ...
        generate_powerpoint: {
          ...
          description: 'Generate PowerPoint presentations with multiple slides, titles, and content.',
        },
        generate_word_document: {
          name: 'Word Document Generator',
          description: 'Generate Word documents with formatted text, headings, and lists.',
        },
        generate_excel_spreadsheet: {
          name: 'Excel Spreadsheet Generator',
          description: 'Generate Excel spreadsheets with multiple sheets, headers, and data.',
        },
      },
    },
    bot: {
...
How would you categorize this email?`,
    ...
    imageGeneration: {
      ...
      negativePromptPlaceholder: 'Describe what you want to avoid in the image...',
      size: 'Image Size',
      cfgScale: 'CFG Scale',
      cfgScaleHelp: 'Controls how closely the image follows the prompt (1-20)',
      seed: 'Seed',
    ...
    videoGeneration: {
      ...
      negativePrompt: 'Negative Prompt',
      negativePromptPlaceholder: 'Describe what you want to avoid in the video...',
      duration: 'Duration',
      durationHelp: 'Video duration in seconds (max 6 seconds)',
      fps: 'Frame Rate',
      seed: 'Seed',
      seedPlaceholder: 'Random seed for reproducible results',
      optional: 'optional',
    ...
    mediaGeneration: {
      pageTitle: 'Media Generation',
      pageDescription: 'Generate images and videos using Amazon Nova Canvas and Nova Reel',
      results: 'Generated Media',
      noResults: 'No media generated yet',
      getStarted: 'Select a generation mode and create your first image or video!',
    },
  },
};
