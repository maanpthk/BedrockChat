...
from app.agents.tools.document_generation import (
    powerpoint_generation_tool,
    word_document_generation_tool,
    excel_spreadsheet_generation_tool,
)
...
def get_available_tools() -> list[AgentTool]:
    ...
    tools.append(powerpoint_generation_tool)
    tools.append(word_document_generation_tool)
    tools.append(excel_spreadsheet_generation_tool)
    return tools
